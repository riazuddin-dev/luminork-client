...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold capitalize tracking-wide ring-1 ring-inset transition-colors duration-200",
        tones[tone],
        className
      )}
    >
